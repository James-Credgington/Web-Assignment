...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <table runat="server" class="form">
        ...
        <tr>
            <td class="firstColumn">Email Address</td>
        ...
        <td class="contactForm" style="width: 168px">
            <asp:TextBox ID="Txt_EnquiryInformation" runat="server" TextMode="MultiLine" Width="248px"></asp:TextBox>
        </td>
        <td class="thirdColumn">
        ...
        <tr>
          <td class="auto-style1">Are you a Student</td>
