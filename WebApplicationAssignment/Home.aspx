<%@ Page Language="C#" Title="Higher Education Chesterfield College - Home" Debug="true" MasterPageFile="~/MasterPages/Master_User.master"
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="cpMainSection" runat="server"> 
        ...
        <section class="openDays" > <!-- start of ssection for the openDays class -->
        ...
        <div class="favouriteCourses"> <!-- start of div with class 'favouriteCourses' -->
            <h2>Favourite Courses</h2> <!-- subheading Favourite Courses -->
        </div><!-- end of div -->
        <!-- end of content page -->
  </asp:Content>
