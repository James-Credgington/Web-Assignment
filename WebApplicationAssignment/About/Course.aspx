...
<asp:Content ID="Content1" ContentPlaceHolderID="cpMainSection" Runat="Server"> <!-- start of the content page -->
   ...
   <h1><asp:Label ID="TitleLabel" runat="server"></asp:Label></h1><!-- heading as a label that changes dynamically depending on the course seleccted from the previous page -->
    ...
    <!-- the buttons below for when the favourite courses has been pressed -->
    <asp:Button ID="TurnOnFavCourses" runat="server" SkinID="Button" CssClass="rightButton" Text="Set as Favourite Course" CausesValidation="False" OnClick="TurnOnFavCourses_Click"/>
    <asp:Button ID="TurnOffFavCourses" runat="server" SkinID="Button" CssClass="rightButton" Text="Don't set as Favourite Course" CausesValidation="False" OnClick="TurnOffFavCourses_Click"
    ...
    <asp:DetailsView ID="addComment" runat="server" AutoGenerateRows="False" DataKeyNames="ID" DataSourceID="AddIntoCommentTable" DefaultMode="Insert" Height="50px" Width="752px" 
        GridLines="None">
     <Fields>
      ...
      <asp:TemplateField HeaderText="Email Address" SortExpression="EmailAddress">
        <EditItemTemplate>
          ...
          <asp:RequiredFieldValidator ControlToValidate="Txt_EmailAddress" runat="server" ErrorMessage="Type in your email address please" CssClass="errorMessage" /><br />
