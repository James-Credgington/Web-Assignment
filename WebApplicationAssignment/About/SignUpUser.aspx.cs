...
public partial class About_SignUp : BasePage /* when the About_SignUp class is inherited by super class BasePage */
{
    ...
    public void AddNewPerson() // start of AddNewPerson method
    {
        ...
        SqlCommand cmd = new SqlCommand("INSERT INTO UserLogin ([FirstName], [Surname], [DateOfBirth], [Gender], [EmailAddress], [PhoneNumber], [CurrentStudent], " +
            "[Password], [LoggedOn]) VALUES (@FirstName, @Surname, @DateOfBirth, @Gender, @EmailAddress, @PhoneNumber, @CurrentStudent, @Password, @LoggedOn)", con);
